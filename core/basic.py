...
from string_utils import string_with_arrows
...
class Error:
    ...
    def as_string(self):
        ...
        result += f'On line {self.pos_start.ln + 1}, in "{self.pos_start.fn}"'
...
global_symbol_table.set('printReturn', BuiltInFunction.print_ret)
