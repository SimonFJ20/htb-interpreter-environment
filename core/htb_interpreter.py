...
from htb_context import Context
from htb_lexer import Lexer, RTError
from htb_parser import Parser
from htb_runtimeresult import RTResult
from htb_symboltable import SymbolTable
from htb_token import *
...
def global_symbol_table() -> SymbolTable:
    ...
    table.set('isNumber', BuiltInFunction.is_number)
    table.set('isString', BuiltInFunction.is_string)
    table.set('isList', BuiltInFunction.is_list)
    table.set('isFunction', BuiltInFunction.is_function)
